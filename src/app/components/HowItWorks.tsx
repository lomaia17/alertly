  ...
  const steps = [
    {
      ...
      icon: <MessageSquareHeart size={40} className="text-indigo-600 dark:text-indigo-400 mb-4 mx-auto" />,
    },
    {
      title: '2. We Scan the Web',
      desc: 'Our bot checks multiple job boards daily so you don’t have to.',
      icon: <Globe size={40} className="text-indigo-600 dark:text-indigo-400 mb-4 mx-auto" />,
    },
    {
      title: '3. Get Daily Alerts',
      desc: 'Receive curated job opportunities directly to your inbox every morning.',
      icon: <MailOpen size={40} className="text-indigo-600 dark:text-indigo-400 mb-4 mx-auto" />,
    },
  ];
    ...
    <section className="py-20 px-6 bg-gray-50 dark:bg-gray-900 text-center">
      ...
      <div className="grid md:grid-cols-3 gap-10 max-w-6xl mx-auto">
        {steps.map((step, index) => (
          <div key={index} className="p-6 rounded-lg bg-white dark:bg-gray-800 shadow-md hover:shadow-xl transition">
            {step.icon}
